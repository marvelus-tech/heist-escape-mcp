 ...
 * line. StagePage keeps owning the markup; we only add classes. Module A's HUD
 * renders rows as `.tick-item`; `.action-item` is kept for the legacy layout.
 */

const ITEM_SELECTOR = '.tick-item, .action-item';
